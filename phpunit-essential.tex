...
\begin{frame}[plain]{Fixture}
    \begin{fullpageitemize}
        \item \color{colororange}{\inconsolatafont{setUpBeforeClass()}}
        \item \color{colorhgray}{Class under test}
        \item \color{colororange}{\inconsolatafont{setUp()}}
        \item \color{colorhgray}{Test cases}
        \item \color{colororange}{\inconsolatafont{tearDown()}}
        \item \color{colorhgray}{Final test case}
        \item \color{colororange}{\inconsolatafont{tearDownAfterClass()}}
    \end{fullpageitemize}
\end{frame}
